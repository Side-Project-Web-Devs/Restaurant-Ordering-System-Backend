...
urlpatterns = [
   ...
   path('availability/<slug:slug>', views.product_availability, name='unavailable'),
   path('return_availability/<slug:slug>/', views.return_availability, name='available'),
   ...
   path('feedback_cusview/<slug:slug>/', views.feedback_cusview, name='feedback_cusview'),

   path('customer_list/', views.customer_list, name='customer_list'),
   path('customer_order/<slug:slug>/', views.view_customer_order, name='customer_order'),
